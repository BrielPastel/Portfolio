public class ListaEncadeada {
    ...
    public void inserePrimeiro(Integer info){
    ...
    public void insereDepois(Node node, Integer info){
        if (!vazia()) {
    ...
    public void insereDepois(Integer antigo, Integer info){
        Node noAntigo = getNode(antigo);
        insereDepois(noAntigo,info);
    }

    public Node getNode(Integer valor){
    ...
    public void insereUltimo(Integer info){
        if (!vazia()){
            Node novoNode = new Node(info);
    ...
    public Node remove(Integer info){
        if (!vazia()){
